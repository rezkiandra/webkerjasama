...
if ($op == 'hapus' && isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql1       = "DELETE FROM tb_kemitraan_keluar WHERE id = '$id'";
...
if ($op == 'edit' && isset($_GET['id']) && !empty($_GET['id'])) {
    $id         = $_GET['id'];
    $id         = enkripsiUrl('decrypt', $id);
    $sql1       = "SELECT * FROM tb_kemitraan_keluar WHERE id = '$id'";
    $q1         = mysqli_query($koneksi, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create data
    ...
    if ($op == 'edit' && isset($_GET['id']) && !empty($_GET['id'])) { //untuk update
        $sql1       = "UPDATE tb_kemitraan_keluar SET foto = '$foto' WHERE id = '$id'";
        $q1         = mysqli_query($koneksi, $sql1);
        if ($q1) {
        ...
        $sql1   = "INSERT INTO tb_kemitraan_keluar(foto) VALUES ('$foto')";
        $q1     = mysqli_query($koneksi, $sql1);
        if ($q1) {
...
<head>
    ...
    <title>Admin - Kemitraaan Keluar</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <h4 class="page-title pull-left">Kemitraan Keluar</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="./">Admin</a></li>
                                <li><span>Kemitraan Keluar</span></li>
                            </ul>
                        </div>
                    </div>
        ...
        <section id="record" class="py-5 my-5">
            <div class="container-fluid">
                <table id="myTable" class="hover display cell-border stripe">
                    ...
                    <tbody>
                        <?php
                        $sql   = "select * from tb_kemitraan_keluar order by id";
